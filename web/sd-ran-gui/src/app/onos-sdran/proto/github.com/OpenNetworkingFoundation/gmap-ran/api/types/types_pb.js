// source: github.com/OpenNetworkingFoundation/gmap-ran/api/types/types.proto
/**
 * @fileoverview
 * @enhanceable
...
proto.ran.trafficsim.types.Route.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    lengthm: jspb.Message.getFieldWithDefault(msg, 3, 0)
  };
...
/**
 * optional uint64 lengthm = 3;
 * @return {number}
 */
proto.ran.trafficsim.types.Route.prototype.getLengthm = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};


/** @param {number} value */
proto.ran.trafficsim.types.Route.prototype.setLengthm = function(value) {
 ...
 * @return {string}
 */
proto.ran.trafficsim.types.Ue.prototype.getColor = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};


/** @param {string} value */
proto.ran.trafficsim.types.Ue.prototype.setColor = function(value) {

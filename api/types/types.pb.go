...
type Cell struct {
	...
	ConfigAttributes map[ConfigKey]ConfigValue `protobuf:"bytes,12,rep,name=configAttributes,proto3,castkey=ConfigKey,castvalue=ConfigValue" json:"configAttributes,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *Cell) GetConfigAttributes() map[ConfigKey]ConfigValue {
	if m != nil {
...
func init() {
	...
	proto.RegisterMapType((map[ConfigKey]ConfigValue)(nil), "ran.trafficsim.types.Cell.ConfigAttributesEntry")
...
var fileDescriptor_386b2e9db948721e = []byte{
	...
	,
}
...
func (m *Cell) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.ConfigAttributes) > 0 {
		for k := range m.ConfigAttributes {
			v := m.ConfigAttributes[k]
			baseI := i
			if len(v) > 0 {
				i -= len(v)
				copy(dAtA[i:], v)
...
func (m *Cell) Size() (n int) {
	...
	if len(m.ConfigAttributes) > 0 {
		for k, v := range m.ConfigAttributes {
			_ = k
			_ = v
			l = 0
			if len(v) > 0 {
...
func (m *Cell) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ConfigAttributes", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ConfigAttributes == nil {
				m.ConfigAttributes = make(map[ConfigKey]ConfigValue)
			}
			...
			m.ConfigAttributes[ConfigKey(mapkey)] = ((ConfigValue)(mapvalue))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])

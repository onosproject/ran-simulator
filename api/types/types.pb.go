...
type TowersParams struct {
	...
	// Max num of UEs per cell
	MaxUEsPerCell uint32 `protobuf:"varint,6,opt,name=maxUEsPerCell,proto3" json:"maxUEsPerCell,omitempty"`
	// Avg Cells per tower - between 2 and 4
	AvgCellsPerTower float32 `protobuf:"fixed32,7,opt,name=avgCellsPerTower,proto3" json:"avgCellsPerTower,omitempty"`
}
...
func (m *TowersParams) GetMaxUEsPerCell() uint32 {
	if m != nil {
		return m.MaxUEsPerCell
	}
	return 0
}

func (m *TowersParams) GetAvgCellsPerTower() float32 {
	if m != nil {
		return m.AvgCellsPerTower
	}
	return 0
}
...
func (*MapLayout) Descriptor() ([]byte, []int) {
	return fileDescriptor_386b2e9db948721e, []int{8}
}
...
var fileDescriptor_386b2e9db948721e = []byte{
	...
	,
}
...
func (m *TowersParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.AvgCellsPerTower != 0 {
		i -= 4
		encoding_binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.AvgCellsPerTower))))
		i--
		dAtA[i] = 0x3d
	}
	if m.MaxUEsPerCell != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.MaxUEsPerCell))
		i--
		dAtA[i] = 0x30
	}
...
func (m *TowersParams) Size() (n int) {
	...
	if m.MaxUEsPerCell != 0 {
		n += 1 + sovTypes(uint64(m.MaxUEsPerCell))
	}
	if m.AvgCellsPerTower != 0 {
		n += 5
	}
...
func (m *TowersParams) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxUEsPerCell", wireType)
			}
			m.MaxUEsPerCell = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxUEsPerCell |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 7:
			if wireType != 5 {
				return fmt.Errorf("proto: wrong wireType = %d for field AvgCellsPerTower", wireType)
			}
			var v uint32
			if (iNdEx + 4) > l {
				return io.ErrUnexpectedEOF
			...
			v = uint32(encoding_binary.LittleEndian.Uint32(dAtA[iNdEx:]))
			iNdEx += 4
			m.AvgCellsPerTower = float32(math.Float32frombits(v))
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
			if err != nil {

...
type Tower struct {
	...
	CrntiMap   map[string]string `protobuf:"bytes,9,rep,name=crntiMap,proto3" json:"crntiMap,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (m *Tower) GetCrntiMap() map[string]string {
	if m != nil {
		return m.CrntiMap
	}
	return nil
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "ran.trafficsim.types.Tower.CrntiMapEntry")
...
var fileDescriptor_386b2e9db948721e = []byte{
	...
	,
}
...
func (m *Tower) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			...
			if m.CrntiMap == nil {
				m.CrntiMap = make(map[string]string)
			}
			var mapkey string
			var mapvalue string
			for iNdEx < postIndex {

...
// Package service houses implementations of various application-oriented interfaces
// for the ONOS RAN subsystem.
package service
...
// Server provides NB gRPC server for gmap-ran.
type Server struct {
	cfg      *ServerConfig
	services []Service
}
...
// NewServer initializes gRPC server using the supplied configuration.
...
// Serve starts the NB gRPC server.

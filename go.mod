...
require (
	...
	github.com/onosproject/onos-e2-sm/servicemodels/e2sm_kpm v0.7.51
	github.com/onosproject/onos-e2-sm/servicemodels/e2sm_kpm_v2 v0.7.51
	github.com/onosproject/onos-e2-sm/servicemodels/e2sm_mho v0.7.51
	github.com/onosproject/onos-e2-sm/servicemodels/e2sm_rc_pre v0.7.51

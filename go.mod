...
require (
	github.com/atomix/atomix-go-client v0.5.21 // indirect
	...
	github.com/onosproject/onos-e2-sm/servicemodels/e2sm_kpm_v2 v0.7.59 // indirect
	...
	github.com/onosproject/onos-e2t v0.0.0-00010101000000-000000000000

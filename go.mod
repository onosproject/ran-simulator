...
require (
	...
	github.com/onosproject/onos-e2-sm/servicemodels/e2sm_kpm v0.8.2
	github.com/onosproject/onos-e2-sm/servicemodels/e2sm_kpm_v2_go v0.8.2
	github.com/onosproject/onos-e2-sm/servicemodels/e2sm_mho_go v0.8.2
	github.com/onosproject/onos-e2-sm/servicemodels/e2sm_rc_pre_go v0.8.2

...
Ransim is capable of simulating an arbitrary number of E2 nodes. The E2 nodes can be defined
statically in the simulation model ([Simulation Model](model.md)) in the Ransim helm chart
or can be added/removed at runtime using [Ransim APIs](api.md).
